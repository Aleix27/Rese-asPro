        ...
        <section className="min-h-screen relative overflow-hidden flex items-center pt-24 md:pt-20 pb-12 md:pb-0">
            ...
            <div className="container mx-auto px-4 md:px-6 relative z-10">
                <div className="grid lg:grid-cols-2 gap-8 md:gap-16 items-center">
                    {/* Left: Text content - minimal but impactful */}
                    <motion.div
                    ...
                    >
                        ...
                        {/* Main headline - BIG and impactful */}
                        <motion.h1
                            className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-black leading-none mb-6 md:mb-8"
                    ...
                    >
                        ...
                        <motion.div
                            ...
                            className="relative bg-white rounded-2xl md:rounded-[2rem] p-6 md:p-8 shadow-2xl border border-gray-100 mx-4 md:mx-0"
                        >
                            {/* Stars rating */}
                            <div className="flex justify-center gap-1 mb-4 md:mb-6">
                                {[...Array(5)].map((_, i) => (
                                    ...
                                    >
                                        <Star className="w-8 h-8 md:w-10 md:h-10 text-accent fill-accent drop-shadow-lg" />
                                    </motion.div>
                                ))}
                            </div>
                            ...
                            <motion.div
                                ...
                                className="flex items-center justify-center gap-2 bg-success/10 rounded-full py-2 md:py-3 px-4 md:px-6"
                            >
                            ...
                            <motion.div
                                ...
                                className="absolute -top-4 -right-4 md:-top-6 md:-right-6 w-12 h-12 md:w-16 md:h-16 bg-gradient-to-r from-accent to-coral rounded-xl md:rounded-2xl flex items-center justify-center shadow-lg"
                            >
                                <Shield className="w-6 h-6 md:w-8 md:h-8 text-white" />
                            </motion.div>
                        </motion.div>

                        {/* Floating review cards - hidden on small mobile */}
                        <motion.div
                            initial={{ opacity: 0, x: -30 }}
                            animate={{ opacity: 1, x: 0 }}
                            transition={{ delay: 1.2 }}
                            className="absolute -left-2 md:-left-8 top-1/4 bg-white rounded-xl md:rounded-2xl p-3 md:p-4 shadow-xl border border-gray-100 max-w-[160px] md:max-w-[200px] hidden sm:block"
                        >
                        ...
                        <motion.div
                            ...
                            className="absolute -right-2 md:-right-4 bottom-1/4 bg-gradient-to-r from-primary to-secondary rounded-xl md:rounded-2xl p-3 md:p-4 shadow-xl text-white hidden sm:block"
                        >
